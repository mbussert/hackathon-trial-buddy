...
export function NewFileModal({ caseData }: { caseData: TCase }) {
    ...
    return (
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        >
          ...
          <NewFileForm caseData={caseData} onSuccess={() => setOpen(false)} />
        </DialogContent>
      </Dialog>
    )
  }
  ...
  return (
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent>
        ...
        <NewFileForm caseData={caseData} className="px-4" onSuccess={() => setOpen(false)} />
